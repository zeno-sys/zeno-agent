...
# from constants import get_zeno_home
...
class MemoryStore:
    ...
    def __init__(
        ...
        self.mem_dir = mem_dir or get_memory_dir()
    ...
    def load_from_disk(self):
        ...
        self.memory_entries = self._read_file(self.mem_dir / "MEMORY.md")
        self.user_entries = self._read_file(self.mem_dir / "USER.md")
    ...
    def _path_for(self, target: str) -> Path:
        if target == "user":
            return self.mem_dir / "USER.md"
        return self.mem_dir / "MEMORY.md"
...
def tool_error(message: str) -> str:
    """Return a JSON error response for tool execution failures."""
...
def memory_tool(
    ...
    """
    if store is None:
        return tool_error("Memory is not available. It may be disabled in config or this environment.")
