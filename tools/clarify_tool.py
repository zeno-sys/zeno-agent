...
if __name__ == "__main__":
    ...
    # Mock Agent Function Call
    tool_name = "clarify"
    tool_input = {"question": "你想做什么？", "choices": ["选项A", "选项B"]}
    extra_args = {"callback": my_callback}
    result = registry.dispatch(tool_name, tool_input, extra_args=extra_args)
    print(result)
